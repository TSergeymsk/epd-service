...
"""
    ...
    # Проверяем, что присутствуют либо нормализованные имена, либо исходные
    assert ('ХВС' in service_names) or ('ХВС КПУ' in service_names)
    assert ('ГВС' in service_names) or ('ГВС КПУ' in service_names)
